...
express-validator: sanitize(), check() and other sanitization-only middlewares have been deprecated.
...
/* This can be refactored after sanitization middleware deprecated, added escape and toDate above
  // Sanitize fields.
...
exports.author_update_post = [
    ...
    //After validation/sanitation, process request, store validation errors
